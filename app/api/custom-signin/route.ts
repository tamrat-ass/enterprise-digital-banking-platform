...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[SignIn] ========== SIGNIN START ==========')
    console.log('[SignIn] Email:', email)
    console.log('[SignIn] Password received:', password)
    console.log('[SignIn] Password length:', password?.length)
    console.log('[SignIn] Password bytes:', password ? Buffer.from(password).toString('hex') : 'EMPTY')
    ...
    console.log(`[SignIn] Account userId: ${targetAccount.userId}`)
    console.log(`[SignIn] Account recordedAt: ${targetAccount.updatedAt}`)
    ...
    console.log(`[SignIn] Account ID: ${targetAccount.id}`)
    console.log(`[SignIn] Account password hash first 30 chars: ${targetAccount.password?.substring(0, 30) || 'NULL/UNDEFINED'}`)
    console.log(`[SignIn] Password length: ${password.length}`)
    ...
    console.log(`[SignIn] Password match result (double check): ${passwordMatch}`)
    console.log(`[SignIn] Input password (double check): ${password}`)
    console.log(`[SignIn] Hash (first 30 chars, double check): ${targetAccount.password.substring(0, 30)}...`)
